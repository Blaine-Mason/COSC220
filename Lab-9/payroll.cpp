...
PayRoll PayRoll::operator+(PayRoll p1, PayRoll p2){
	PayRoll rtn(this->name, (p1->payRate + p2->payRate), (p1->hours, p2->hours));
	return rtn;
}
bool PayRoll::operator<(PayRoll p1, PayRoll p2){
